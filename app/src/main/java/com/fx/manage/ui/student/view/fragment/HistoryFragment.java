...
import com.fx.manage.bean.Borrow;
 ...
 */
public class HistoryFragment extends BaseFragment<HistoryPresenter, HistoryModel> implements HistoryContract.View {
    @BindView(R.id.ntb)
    NormalTitleBar ntb;
    Unbinder unbinder;
    ...
    public void onHiddenChanged(boolean hidd) {
        if (hidd) {
            ...
            if (mAdapter.getCount() <= 0) {
                mPresenter.getBorrowMessagesListRequest(AppApplication.student_user.getUserid(), AppConstant.SEND_BORROW);//查询
            }
        }
    }
    ...
    protected void initView() {
        ...
        ntb.setTitleText(getString(R.string.history_title));
